namespace Lantmäteriet.kartor.downloader.test
{
    ...
    {
        private string url = "http://kso.lantmateriet.se/karta/allmannakartor/wms/v1?Layers=sverigekartan&EXCEPTIONS=application%2Fvnd.ogc.se_xml&FORMAT=image%2Fpng&TRANSPARENT=TRUE&STYLES=default&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&SRS=EPSG%3A3006&BBOX=372864,7059296,503936,7190368&WIDTH=512&HEIGHT=512";
